...
<body>
  ...
  <div style="text-align: center;">
    ...
    <form method="post" action="index.php?login=0" onsubmit="return formValidate()">
    ...
    <a href="admin.php?login=0" style="color: white;"><button style="color: white; background: green;border-radius: 5px; border: none;cursor: pointer;">Admin Login</button></a>
